<template>
  <header>
    ...
    >
      <p>Configurações</p>
      <div class="container-class-config">
        <svg
          version="1.1"
...
.button-config:hover p {
  animation: 1s showConfigP forwards;
}

.button-config:hover .container-class-config .class-config {
  animation: 3s rotateIconConfig infinite;
}

.button-config .container-class-config {
  margin: 0 0.5em;

  padding: 0.5em 0.5em;
}

.button-config:hover .container-class-config {
  background-color: rgb(59, 59, 59);
}

.button-config .container-class-config .class-config {
  height: 1em;
}
...
@keyframes borderLogo {
  ...
  100% {
    -webkit-box-shadow: 0px 0px 18px 0px rgba(138, 138, 138, 1);
    -moz-box-shadow: 0px 0px 18px 0px rgba(138, 138, 138, 1);
    box-shadow: 0px 0px 18px 0px rgba(138, 138, 138, 1);
  }
}

@keyframes showConfigP {
  0% {
    opacity: 0;
  }
